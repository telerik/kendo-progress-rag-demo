...
export default function FinanceAnalysis() {
  ...
  const chatBot = useChatBot({
    ...
    initialMessage: 'Hello! I\'m your Nuclia Financial assistant. I can help you by summarizing financial data and answering questions about companies. Try one of the suggestions below, or ask me anything about financial results of Apple, Amazon, Resolute, Exxon Mobil, Johnson&Jonson, Google, NVIDIA or Berkshire Hathaway!',
  ...
  React.useEffect(() => {
    if (chatBot.latestResponse?.json?.charts && Array.isArray(chatBot.latestResponse.json.charts)) {
